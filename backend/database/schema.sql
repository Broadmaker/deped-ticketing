...
CREATE TABLE IF NOT EXISTS csm_surveys (
  ...
  cc1                  VARCHAR(5)   DEFAULT NULL,
  cc2                  VARCHAR(5)   DEFAULT NULL,
  cc3                  VARCHAR(5)   DEFAULT NULL,
  sqd0                 VARCHAR(5)   DEFAULT NULL,
  sqd1                 VARCHAR(5)   DEFAULT NULL,
  sqd2                 VARCHAR(5)   DEFAULT NULL,
  sqd3                 VARCHAR(5)   DEFAULT NULL,
  sqd4                 VARCHAR(5)   DEFAULT NULL,
  sqd5                 VARCHAR(5)   DEFAULT NULL,
  sqd6                 VARCHAR(5)   DEFAULT NULL,
  sqd7                 VARCHAR(5)   DEFAULT NULL,
  sqd8                 VARCHAR(5)   DEFAULT NULL,
